	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="helpLinks">
						<a href="https://www.galaxybd.com">Galaxy Website</a> | 
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container">
										<div><h2> Get more out of Galaxy </h2></div>
										<ul class="bxslider">
											<li>
												<div id="slide01" class="slide">
													<img class="pull-left" src="{vimage_path('GTI.png')}">
													<img class="pull-right" src="{vimage_path('')}"/>
												</div>
											</li>
											<li>
												<div id="slide02" class="slide">
													<img class="pull-left" src="{vimage_path('ghd.png')}"/>
													<img class="pull-right" src="{vimage_path('')}"/>
												</div>
											</li>
											<li>
												<div id="slide03" class="slide">
													<img class="pull-left" src="{vimage_path('ghc.png')}"/>
													<img class="pull-right" src="{vimage_path('')}"/>
												</div>
											</li>
											<li>
												<div id="slide04" class="slide">
													<img class="pull-left" src="{vimage_path('GWL.png')}"/>
													<img class="pull-right" src="{vimage_path('')}"/>
												</div>
											</li>
											<li>
												<div id="slide05" class="slide">
													<img class="pull-left" src="{vimage_path('outlook_text1.png')}"/>
													<img class="pull-right" src="{vimage_path('outlook1.png')}"/>
												</div>
											</li>
										</ul>
									</div>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login to Galaxy CRM</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
											...
											<div class="login-subscript">
												<small> Powered by Galaxy BD 1.2</small>
											</div>
				</div>
